...
export default function StudentsFilters({ isClass, classes: promotions, query, select, handleChange, handleSelectChange }) {
    ...
    return (
        <section
            ...
            className='bg-secondary/30 dark:bg-secondaryDark/60 relative rounded-t-xl pt-8 px-4 md:px-12 mt-6 flex flex-col md:flex-row items-center'
        >
            <div
                style={
                    {
                        flexBasis: isClass ? '100%' : null
                    }
                }
                className='relative w-full md:basis-5/12 mr-0 md:mr-6 mb-2 md:mb-0'>
                <input
                    type='text'
